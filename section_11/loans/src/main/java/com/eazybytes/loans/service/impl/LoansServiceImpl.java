...
import com.eazybytes.loans.exception.LoanCalculationErrorException;
...
public class LoansServiceImpl implements ILoansService {
    ...
    public boolean updateLoan(LoansDto loansDto) {
        ...
        if(!loansDto.getLoanNumber().equals(loans.getLoanNumber())) {
        ...
        if(loansDto.getOutstandingAmount() != (loansDto.getTotalLoan() - loansDto.getAmountPaid())) {
            throw new LoanCalculationErrorException();
        }
