...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(LoanCalculationErrorException.class)
    public ResponseEntity<ErrorResponseDto> handleLoanCalculationErrorException(LoanCalculationErrorException exception,
                                                                                WebRequest webRequest) {
